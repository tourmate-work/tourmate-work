...
export function StatsSection() {
  ...
  return (
    <section id="about" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      {/* Container */}
      <div className="bg-slate-50 border border-slate-200/80 rounded-[2.5rem] p-8 sm:p-12 lg:p-16 text-center">
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="flex flex-col items-center">
                ...
                {/* Card */}
                <div className="w-full bg-black hover:bg-slate-900 text-white rounded-2xl p-5 shadow-lg shadow-black/10 flex items-center justify-center gap-4 transition-all duration-300 hover:-translate-y-1">
                  <div className="h-12 w-12 rounded-xl bg-white/10 flex items-center justify-center text-white backdrop-blur-sm flex-shrink-0">
