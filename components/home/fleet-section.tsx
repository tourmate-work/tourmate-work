...
export function FleetSection() {
  ...
  // Generate 9 cards per page for realistic pagination
  const getCarsForPageAndCategory = (page: number, category: string): CarItem[] => {
    const baseModels = [
      { name: "Mercedes", price: "LKR 2500", cat: "Sedan", fuel: "70 Ltr" },
      { name: "Mercedes", price: "LKR 2500", cat: "Sedan", fuel: "70 Ltr" },
      { name: "Mercedes", price: "LKR 2500", cat: "Sedan", fuel: "70 Ltr" },
      { name: "Mercedes", price: "LKR 2800", cat: "Sedan", fuel: "70 Ltr" },
      { name: "Mercedes", price: "LKR 2800", cat: "Sedan", fuel: "70 Ltr" },
      { name: "Mercedes", price: "LKR 2800", cat: "Sedan", fuel: "70 Ltr" },
      { name: "Mercedes", price: "LKR 2500", cat: "Sedan", fuel: "70 Ltr" },
      { name: "Mercedes", price: "LKR 2500", cat: "Sedan", fuel: "70 Ltr" },
  ...
  return (
    <section id="vehicles" className="w-full bg-white pt-10 pb-16">
