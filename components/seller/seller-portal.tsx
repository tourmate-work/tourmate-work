                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2">
                              <div>
                                <span className="text-[10px] font-extrabold uppercase tracking-wider bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 px-2 py-0.5 rounded-md">
                                  {item.id} • On Road
                                </span>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2.5">
                          <button
                            ...
                            className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold px-4 py-2.5 rounded-full shadow-md transition-all active:scale-95"
                          >
                            Accept & Reserve
                          </button>
                          <a
                            href={`https://wa.me/${SITE_CONTACT.whatsappNumber}?text=${encodeURIComponent(`Hi ${item.renterName}, confirming your Tourmate rental for ${item.vehicleName}.`)}`}
                            target="_blank"
                            rel="noreferrer"
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-[#0b0b0e] p-4 rounded-[30px] border border-slate-200/80 dark:border-white/10 shadow-sm">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-full text-xs font-bold shadow-md transition-all active:scale-95"
                >
                  <Plus className="h-4 w-4" />
                  <span>List New Vehicle</span>
                </button>
                      ...
                      <div>
                        ...
                        <div className="flex items-start justify-between gap-2 mb-4">
                          ...
                          <div className="text-right">
                            <span className="text-lg font-bold text-emerald-600 dark:text-emerald-400 block leading-tight">
                  ...
                  {filteredBookings.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 lg:gap-8 text-xs">
                        ...
                        <a
                          href={`https://wa.me/${SITE_CONTACT.whatsappNumber}?text=${encodeURIComponent(`Tourmate Host Notification: Booking ${item.id} for ${item.vehicleName}`)}`}
                          target="_blank"
                          rel="noreferrer"
