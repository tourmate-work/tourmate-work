...
export const translations = {
  ...
  modal_phone_valid: { en: "Valid phone number", si: "වලංගු දුරකථන අංකයකි" },
  modal_email_valid: { en: "Valid email address", si: "වලංගු විද්‍යුත් ලිපිනයකි" },
  modal_err_name: { en: "Please enter your full name.", si: "කරුණාකර ඔබගේ සම්පූර්ණ නම ඇතුළත් කරන්න." },
  modal_err_phone: { en: "Please enter a valid WhatsApp / phone number.", si: "කරුණාකර වලංගු WhatsApp හෝ දුරකථන අංකයක් ඇතුළත් කරන්න." },
  modal_err_email: { en: "Please enter a valid email address.", si: "කරුණාකර වලංගු විද්‍යුත් ලිපිනයක් ඇතුළත් කරන්න." },
